      ...
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        if (props.bodyType === "circle") {
          ...
          body = Bodies.circle(x, y, radius, {
            ...
            angle,
            render: { fillStyle: debug ? "#888" : "#00000000", strokeStyle: debug ? "#333" : "#00000000", lineWidth: debug ? 3 : 0 },
          })
          ...
          paths.forEach((path) => {
            ...
            vertexSets.push(parsePathToVertices(d!, props.sampleLength))
          })
    ...
    const initializeRenderer = useCallback(() => {
      ...
      if (grabCursor) {
        Events.on(engine.current, "beforeUpdate", () => {
          if (canvas.current) {
            canvas.current.style.cursor = !mouseDown.current && !touchingMouse() ? "default" : touchingMouse() ? (mouseDown.current ? "grabbing" : "grab") : "default"
          }
        })
